...
<body class="bg-light">
  ...
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
    <h5 class="my-0 mr-md-auto font-weight-normal"><a href="<?php echo URL; ?>">Sistema de pedidos</a></h5>
    <nav class="my-2 my-md-0 mr-md-3">
      <a class="p-2 text-dark" href="proveedores">Proveedores</a>
      <a class="p-2 text-dark" href="productos">Productos</a>
      <a class="p-2 text-dark" href="pedidos">Pedidos</a>
